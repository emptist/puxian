...
st.set_page_config(page_title='圣者贤行愿王释义') #,layout="wide") #,initial_sidebar_state=st.session_state.sidebar_state)

title = '圣者贤行愿王释义'
# st.title(title) 
st.markdown(f'# {title}')
st.markdown('#### 章嘉游戏金刚造 藏文汉译汤芗铭译')
...
with col1:
    ...
    """
    ,
    language='Markdown',line_numbers=True)
    #,
    #line_numbers=True)
...
1.  甲四、释经义—经中所明缘起理趣
1.  甲四、释经义—梵土诸疏所释理趣
1.  甲四、释经义—正释经义—成就愿因，积集净治修学次第
1.  甲四、释经义—正释经义—正修菩萨愿之次第
1.  甲四、释经义—正释经义—作意思惟此愿胜利
1.  甲四、释经义—正释经义—诵持文等一切胜利
1.  自序注释
1.  释论注释
